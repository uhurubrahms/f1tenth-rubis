...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'drive_straight' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tigerlily/rubis/install/${idir}'.  Ask the maintainer 'tigerlily <tigerlily@todo.todo>' to fix it.")
    endif()
