...
(cl:in-package drive_straight-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <drive_values>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_values)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drive_straight-msg:<drive_values> is deprecated: use drive_straight-msg:drive_values instead.")))

(cl:ensure-generic-function 'pwm_drive-val :lambda-list '(m))
(cl:defmethod pwm_drive-val ((m <drive_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_straight-msg:pwm_drive-val is deprecated.  Use drive_straight-msg:pwm_drive instead.")
  (pwm_drive m))

(cl:ensure-generic-function 'pwm_angle-val :lambda-list '(m))
(cl:defmethod pwm_angle-val ((m <drive_values>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drive_straight-msg:pwm_angle-val is deprecated.  Use drive_straight-msg:pwm_angle instead.")
  (pwm_angle m))
